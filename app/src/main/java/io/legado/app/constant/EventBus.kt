...
object EventBus {
    ...
    const val WEB_SERVICE = "webService"                    // Web 服务状态变更
    const val DEBUG_MODE_CHANGED = "debugModeChanged"       // 调试模式开关变更
    ...
    // ── 朗读 / TTS ──
    const val ALOUD_STATE = "aloud_state"                   // 朗读状态变更
    ...
    const val SHOW_READ_MENU = "showReadMenu"               // 显示阅读菜单

    // ── 音频播放 ──
    const val AUDIO_DS = "audioDs"                          // 音频数据源变更
    const val AUDIO_STATE = "audioState"                    // 音频播放状态变更
    ...
    const val UP_DOWNLOAD_STATE = "upDownloadState"         // 下载状态变更
